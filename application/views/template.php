	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?=base_url("dashboard")?>" class="logo">
				...
				<span class="logo-lg">CRUD<b>IN</b></span>
			</a>
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?=base_url()?>assets/dist/img/aku.jpeg" class="user-image">
								<span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?=base_url()?>assets/dist/img/aku.jpeg" class="img-circle">
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; November 2021 <a href="https://idestory.my.id">Tugas Kelompok7</a>.</strong> All rights reserved.
		</footer>
